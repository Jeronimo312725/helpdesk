...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Registro del nuevo funcionario
      // Registro del nuevo funcionario
...
?>
    ...
    <script>
        // Variables pasadas desde PHP para usar en JavaScript
    ...
    <link rel="stylesheet" href="templates/css/registro.css">
    ...
    <div class="cajita_cucho">
        ...
        <div class="caja_derecha">
            <div class="logo">
                <div id="texto">REGISTRO VIGILANTE</div>
            </div>
            <form action="registro_vigilante.php" method="POST">
            <div class="campos">
                    <label for="numero_documento" class="titulos">Documento de Identidad</label>
                    <input type="text" name="numero_documento" id="numero_documento" placeholder="# Documento" pattern="^\d{6,10}$" required title="Debe contener entre 6 y 10 dígitos numéricos.">
                </div>
                <div class="campos">
                ...
                <div class="registro">
                    Ya tengo cuenta <a href="index.php">Iniciar Sesión</a>
                </div>
            </form>
        </div>
    </div>
